...
<html>
  ...
  <body>
    <form method="post" action="/book/update/{{$book_in_stocks->Book_id}}">
      <!-- <div class="form-group">
        <label class="col-form-label" for="formGroupExampleInput">Book name</label>
        <input type="text" class="form-control" name="Bname" placeholder="stock">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="edition" placeholder="amount">
      </div>
